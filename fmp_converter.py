...
class FMPConverter:
    ...
    @classmethod
    def extract_cash_flow_data(cls, fmp_cashflow_response: Dict[str, Any]) -> Dict[str, Optional[float]]:
        """
        ...
        return {
            ...
            "free_cash_flow": converted_data.get("free_cash_flow"),  # FMP sometimes provides this directly
            "source": "fmp"
        }
