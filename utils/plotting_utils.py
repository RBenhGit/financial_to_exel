...
class PlottingUtils:
    ...
    def create_fcf_comparison_chart(self, fcf_data: Dict[str, List[float]], 
                                   years: List[int],
        ...
        for fcf_type, values in fcf_data.items():
            ...
            chart_values = values[-len(chart_years):] if len(values) >= len(chart_years) else values
        ...
        if show_average and len(fcf_data) > 1:
            ...
            if average_values['values']:
                fig.add_trace(go.Scatter(
                    ...
                    marker=dict(size=12, symbol='diamond', color='#ff4500', 
    ...
    def create_growth_rate_chart(self, growth_rates: Dict[str, Dict[str, Optional[float]]],
    ...
    def create_trend_analysis_chart(self, years: List[int], values: List[float],
                                   title: Optional[str] = None,
                                   show_trend_line: bool = True) -> go.Figure:
        """
    ...
    def create_dcf_waterfall_chart(self, dcf_components: Dict[str, float],
                                  title: Optional[str] = None) -> go.Figure:
        """
    ...
    def _calculate_average_fcf_values(self, fcf_data: Dict[str, List[float]], 
                                    years: List[int]) -> Dict[str, List]:
        """
    ...
    def apply_common_styling(self, fig: go.Figure, 
                           title: Optional[str] = None,
