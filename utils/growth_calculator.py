...
class GrowthRateCalculator:
    ...
    def calculate_growth_rates_for_series(
        self, values: List[Union[float, int]], periods: Optional[List[int]] = None
    ...
    def calculate_fcf_growth_rates(
        self, fcf_data: Dict[str, List[Union[float, int]]], periods: Optional[List[int]] = None
    ...
    def calculate_historical_growth_rates(
        self,
        financial_metrics: Dict[str, List[Union[float, int]]],
    ...
    def _calculate_average_growth_rates(
        self, growth_rates: Dict[str, Dict[str, Optional[float]]], periods: List[int]
    ) -> Dict[str, Optional[float]]:
        """
    ...
    def _values_have_opposite_signs(
        self, value1: Union[float, int], value2: Union[float, int]
    ) -> bool:
        """
    ...
    def get_growth_rate_statistics(
        self, growth_rates: Dict[str, Optional[float]]
    ) -> Dict[str, Any]:
        """
        ...
        valid_rates = [
            rate for rate in growth_rates.values() if rate is not None and np.isfinite(rate)
        ]
    ...
    def format_growth_rate(
        self, growth_rate: Optional[float], as_percentage: bool = True, decimal_places: int = 1
    ) -> str:
        """
