...
- **Status**: FAIL
- **Duration**: 4.00s
- **Error**: DCFValuator.__init__() missing 1 required positional argument: 'financial_calculator'
...
- **Status**: FAIL
- **Duration**: 0.00s
- **Error**: 'FinancialCalculator' object has no attribute 'calculate_fcff'
