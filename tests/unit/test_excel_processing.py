...
class TestExcelStructureValidation:
    ...
    def test_company_structure_validation(self, company_data_manager):
        ...
        if companies:
            ...
            expected_keys = [
                'has_fy_folder', 'has_ltm_folder', 
                'has_income_fy', 'has_balance_fy', 'has_cashflow_fy',
                'has_income_ltm', 'has_balance_ltm', 'has_cashflow_ltm',
                'is_complete'
            ]
        ...
        for period in ['FY', 'LTM']:
            for file_path in excel_files.get(period, []):
                if os.path.exists(file_path):
                    ...
                    # Test metric finding
                    common_metrics = [
                        "Period End Date", "Revenue", "Net Income", 
                        "Total Assets", "Cash from Operations"
                    ]
