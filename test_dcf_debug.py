...
def debug_dcf_calculation():
    ...
    print(f"equity_value_actual_currency = {equity_value} * 1,000,000 = {equity_value_actual_currency:,.0f}")
    print(f"value_per_share = {equity_value_actual_currency:,.0f} / {shares_outstanding:,.0f} = ${value_per_share:.2f}")
    ...
    if abs(ratio - 1000000) < 1000:
        ...
        print(f"Expected equity_value should be: {expected_equity_value_for_correct_per_share:,.2f} million")
