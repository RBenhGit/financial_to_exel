...
class AlphaVantageConverter:
    ...
    def convert_financial_data(cls, alpha_vantage_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.debug(
                f"Alpha Vantage conversion completed. Fields: {list(standardized_data.keys())}"
            )
    ...
    def _extract_statement_data(
        cls, data: Dict[str, Any], statement_type: str
    ...
    def _convert_statement(
        cls, statement_data: Dict[str, Any], statement_type: str
    ) -> Dict[str, Any]:
    ...
    def extract_cash_flow_data(
        cls, alpha_vantage_response: Dict[str, Any]
