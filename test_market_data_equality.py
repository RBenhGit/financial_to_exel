...
def test_market_data_equality():
    ...
    for company in companies:
        ...
        try:
            ...
            print(
                f'  ✅ Setup identical: ticker={calc.ticker_symbol}, fetch_method={has_fetch_method}'
            )
    ...
    for company in companies[1:]:
        ...
        if result['status'] != first_result['status']:
            ...
            if (
                result['has_fetch_method'] != first_result['has_fetch_method']
                or result['has_price_attr'] != first_result['has_price_attr']
                or result['has_shares_attr'] != first_result['has_shares_attr']
            ):
                all_identical = False
